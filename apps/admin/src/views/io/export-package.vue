          ...
          <v-card-text class="mt-4">
            ...
            <v-row>
              ...
              <v-col cols="12" md="6">
                ...
                <v-checkbox
                  v-model="includeFlags.locales"
                  density="compact"
                  hide-details
                  :label="$t('io.export.includeOptions.locales')"
                />
                <v-checkbox
                ...
                <v-alert
                  class="mt-2"
                  density="compact"
                  :style="{ opacity: includeFlags.portionSizeImages ? 1 : 0 }"
                  type="warning"
                  variant="tonal"
                >
                  {{ $t('io.export.portionSizeImagesWarning') }}
                </v-alert>
              </v-col>
            </v-row>
            <v-row>
...
const { jobs, startPolling } = usePollsForJobs('PackageExport', undefined, { startedAfter });
...
const includeOptions = computed(() => {
  ...
  if (includeFlags.locales)
    options.push('locales');
