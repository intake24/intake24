...
function getEntities(upto?: number) {
  return state.value.steps.slice(0, upto).reduce((acc, step, idx) => {
...
const entities = computed(() => getEntities());
