...
function update() {
  state.value.portionSize.servingWeight
    = (state.value.portionSize.serving?.weight ?? 0) * state.value.portionSize.quantity * conversionFactor.value * state.value.portionSize.linkedQuantity;
  state.value.portionSize.leftoversWeight
    = (state.value.portionSize.leftovers?.weight ?? 0) * state.value.portionSize.quantity * conversionFactor.value * state.value.portionSize.linkedQuantity;
