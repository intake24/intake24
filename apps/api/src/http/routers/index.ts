...
export function registerRouters(express: Router) {
  ...
  createExpressEndpoints(
    ...
    server.router(adminAuthVerifiedContract, {
      ...
      localeSecurable: admin.securable(SystemLocale, contract.admin.languageSecurable),
      ...
      surveySecurable: admin.securable(Survey, contract.admin.languageSecurable),
      ...
      surveySchemeSecurable: admin.securable(SurveyScheme, contract.admin.languageSecurable),
      task: admin.task(),
