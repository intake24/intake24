...
export function registerRouters(express: Router) {
  ...
  const adminAuthVerifiedMfaContract = {
    ...
    foodDb: contract.admin.fdbs.foodDb,
    category: contract.admin.fdbs.category,
    foods: contract.admin.fdbs.food,
    foodThumbnailImage: contract.admin.fdbs.foodThumbnailImage,
    ...
    localeFoodBuilder: contract.admin.locale.foodBuilder,
    ...
    packages: contract.admin.packages,
  ...
  createExpressEndpoints(
    ...
    server.router(adminAuthVerifiedMfaContract, {
      ...
      foodDb: admin.fdbs.foodDb(),
      category: admin.fdbs.category(),
      foods: admin.fdbs.food(),
      foodThumbnailImage: admin.fdbs.foodThumbnailImage(),
      ...
      localeFoodBuilder: admin.locale.foodBuilder(),
