...
- `addon food` - portion size estimation method will be available in [`addon-foods-prompt`](/admin/surveys/prompt-types#addon-foods-prompt) prompt
...
- `units` - list of [standard units](/admin/foods/standard-units) for the portion size estimation to choose from.
