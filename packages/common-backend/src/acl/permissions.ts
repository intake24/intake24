export const permissions = [
  ...
  { name: 'upload-large-files', displayName: 'Upload large files' },
  ...
  { name: 'as-served-sets:audit', displayName: 'As served sets audit' },
  ...
  { name: 'drinkware-sets:audit', displayName: 'Drinkware sets audit' },
  { name: 'faqs', displayName: 'FAQ resource access' },
  { name: 'faqs:browse', displayName: 'Browse FAQs' },
  { name: 'faqs:read', displayName: 'Read FAQ' },
  { name: 'faqs:create', displayName: 'Create FAQ' },
  { name: 'faqs:edit', displayName: 'Edit FAQ' },
  { name: 'faqs:delete', displayName: 'Delete FAQ' },
  { name: 'faqs:copy', displayName: 'Copy FAQ' },
  { name: 'faqs:media', displayName: 'FAQ media' },
  { name: 'faqs:securables', displayName: 'FAQ security' },
  { name: 'faqs:use', displayName: 'FAQ use' },
  { name: 'faqs:audit', displayName: 'FAQ audit' },
  ...
  { name: 'feedback-schemes:media', displayName: 'Feedback media' },
  ...
  { name: 'feedback-schemes:audit', displayName: 'Feedback schemes audit' },
  ...
  { name: 'guide-images:audit', displayName: 'Guide images audit' },
  ...
  { name: 'image-maps:audit', displayName: 'Image maps audit' },
  ...
  { name: 'languages:audit', displayName: 'Languages audit' },
  ...
  { name: 'locales:food-list', displayName: 'Locale - view food list' },
  ...
  { name: 'locales:audit', displayName: 'Locales audit' },
  { name: 'media', displayName: 'Media resource' },
  { name: 'media:browse', displayName: 'Browse media' },
  { name: 'media:create', displayName: 'Create media' },
  { name: 'media:read', displayName: 'Read media' },
  { name: 'media:edit', displayName: 'Edit media' },
  { name: 'media:delete', displayName: 'Delete media' },
  { name: 'media:audit', displayName: 'Media audit' },
  { name: 'metrics:app', displayName: 'Access application performance metrics via API' },
  { name: 'metrics:node', displayName: 'Access hardware/OS performance metrics via API' },
  { name: 'metrics:heap-snapshots', displayName: 'Heap shapshots generation / creation' },
  ...
  { name: 'nutrient-tables:tasks', displayName: 'Nutrient tables tasks' },
  { name: 'nutrient-tables:audit', displayName: 'Nutrient tables audit' },
  ...
  { name: 'nutrient-types:audit', displayName: 'Nutrient types audit' },
  ...
  { name: 'nutrient-units:audit', displayName: 'Nutrient units audit' },
  { name: 'packages:import', displayName: 'Import food database packages' },
  { name: 'packages:export', displayName: 'Export food database packages' },
  ...
  { name: 'permissions:audit', displayName: 'Permissions audit' },
  ...
  { name: 'roles:audit', displayName: 'Roles audit' },
  ...
  { name: 'standard-units:audit', displayName: 'Standard units audit' },
  ...
  { name: 'survey-scheme-prompts:audit', displayName: 'Survey scheme prompts audit' },
  ...
  { name: 'surveys:audit', displayName: 'Surveys audit' },
  ...
  { name: 'tasks:audit', displayName: 'Tasks audit' },
  ...
  { name: 'users:audit', displayName: 'Users audit' },
] as const;
